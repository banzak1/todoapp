...
\cvitem{}{Desenvolvedor Fullstack Pleno com 4+ anos de experiência em sistemas de missão crítica. No back-end, construí APIs Java/Spring Boot e Go que processam, em tempo real, dados de geolocalização e telemetria de maquinários agrícolas para tomada de decisão em campo, além de integrar fluxos de alerta com Apache Kafka e bancos PostgreSQL/Oracle. No front-end, sou responsável pelo desenvolvimento do PWA do Omni Conectado (Angular, microsserviços), sistema core de financiamentos do Omni Banco --- instituição com meta de R\$ 10 bilhões em receita. Uso ferramentas de IA (Claude, Copilot) no ciclo diário de desenvolvimento para acelerar testes, revisão e entrega com qualidade.}

\section{Competências}
\cvitem{\textbf{Linguagens}}{Java, JavaScript, TypeScript, Go}
\cvitem{\textbf{Front-end}}{Vue.js, Angular, React}
\cvitem{\textbf{Back-end}}{Spring Boot, Node.js, APIs RESTful, Microsserviços, Clean Code, SOLID}
\cvitem{\textbf{Infra \& Dados}}{PostgreSQL, Oracle, MongoDB, ElasticSearch, Apache Kafka, Docker}
\cvitem{\textbf{Ferramentas \& Processos}}{Git, JUnit, Jenkins, Jira, Scrum, IA aplicada ao desenvolvimento}
...
\begin{itemize}
    ...
    \item Construí APIs em Go para dados climáticos (umidade, precipitação, temperatura, vento) consumidos via Kafka, com filtros por cliente, zona ou talhão e gráficos históricos.
    \item Implementei mapa de nuvens em Node.js com atualização a cada 10 segundos, renderizando variações de intensidade de chuva (mm) por cor --- imagens processadas via AWS e exibidas com zoom progressivo.
\end{itemize}}

\cventry{Nov 2021--Mai 2022}{Trainee Dev}{Solinftec}{Araçatuba}{}{
\begin{itemize}
    \item Imersão prática em Java, Vue.js, Kafka, Oracle e PostgreSQL com projetos desafio como: sistema de mapa com movimentação de maquinários em tempo real e plataforma de compra/venda de ações fictícias com atualização a cada segundo via WebSocket + Kafka.
\end{itemize}}
